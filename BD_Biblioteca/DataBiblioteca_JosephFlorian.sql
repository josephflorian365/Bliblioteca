...
INSERT INTO DEVOLUCION(FECHDEVDEV,IDPRE,IDLIB,IDLEC) 
VALUES
(STR_TO_DATE('19/1/2020', '%d/%m/%Y'),'1','1','1'),
(STR_TO_DATE('19/1/2020', '%d/%m/%Y'),'1','2','2'),
(STR_TO_DATE('19/1/2020', '%d/%m/%Y'),'1','3','3'),
(STR_TO_DATE('19/1/2020', '%d/%m/%Y'),'1','4','4'),
(STR_TO_DATE('19/1/2020', '%d/%m/%Y'),'1','5','5');
...
ALTER TABLE DEVOLUCION DROP FOREIGN KEY DEVOLUCION_LIBRO;
ALTER TABLE DEVOLUCION DROP FOREIGN KEY DEVOLUCION_PRESTAMO;
