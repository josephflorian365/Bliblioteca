...
CREATE TABLE DEVOLUCION (
    ...
    IDLEC int NOT NULL COMMENT 'Contiene el identificador del Lector',
...
ALTER TABLE DEVOLUCION ADD CONSTRAINT DEVOLUCION_PRESTAMO FOREIGN KEY DEVOLUCION_PRESTAMO (IDPRE)
    REFERENCES PRESTAMO (IDPRE);
    
ALTER TABLE DEVOLUCION ADD CONSTRAINT DEVOLUCION_LECTOR FOREIGN KEY DEVOLUCION_LECTOR (IDLEC)
...
ALTER TABLE DEVOLUCION ADD CONSTRAINT DEVOLUCION_LIBRO FOREIGN KEY DEVOLUCION_LIBRO (IDLIB)
    REFERENCES LIBRO (IDLIB);
